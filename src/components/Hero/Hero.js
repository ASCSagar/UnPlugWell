    ...
    <section className="relative min-h-[85vh] flex items-center">
      ...
      <div className="relative container mx-auto px-6 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white mb-8">
          ...
          <p className="text-lg md:text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
            Discover how to maintain a healthy relationship with technology
            while staying productive and mindful in the digital age.
          </p>
